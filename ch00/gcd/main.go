...
func main() {
	...
	TrivialGCD(x, y)
	elapsed := time.Since(start) // stop the stopwatch
...
// possible divisor of a and b up to their minimum.
func TrivialGCD(a, b int) int {
	...
	// 	if a % p == 0 {
	// 		// let's now check if p is a divisor of b
	// 		if b % p == 0 {
	// 			// if we are here, we know that p is a divisor
	// 			// of both
	// 			d = p
	// 		}
	// 	}
...
//     return a
//
// EuclidGCD takes as input two integers a and b and returns their
// GCD, following Euclid's algorithm
